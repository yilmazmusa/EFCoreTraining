...
Application6DbContext context = new();
...
//EF Core Optimistic lock yaklaşımı için genetinde yapısal bir özellik barındırmaktadır.Bu da
...
//1.Yöntem  ConcurrencyCheck Attribute
//Propertyi  [ConcurrencyCheck] ile işaretlemek.
...
//2.Yöntem  Fluent API 
//modelBuilder.Entity<Person>().Property(p => p.Name).IsConcurrencyToken(); // Fluent API ile Name kolonunu/propertysini ConcurrencyToken olarak belirledir
...
//1.Yöntem
//[Timestamp]// Bir version bilgisi olduğunu göstermek için [Timestamp] ile işaretliyoruz.
//public byte[] RowVersion { get; set; }


//2.Yöntem Fluent API
//modelBuilder.Entity<Person>().Property(p => p.RowVersion).IsRowVersion();// Fluent API ile RowVersion kolonunun/propertysini RowVersion olarak belirledik.
...
class Application6DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Person>().Property(p => p.Name).IsConcurrencyToken(); // Fluent API ile Name kolonunu/propertysini ConcurrencyToken olarak belirledik ki değişiklik olduğunda Token değişsin bizde değiştiğini anlayalım.
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        optionsBuilder.UseSqlServer("Server=localhost\\sqlexpress;Database=Application6DB; User Id=sa; Password=Annem+.-1966; TrustServerCertificate=True")
